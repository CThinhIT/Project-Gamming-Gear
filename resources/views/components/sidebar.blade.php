        ...
        <div class="logo_content">
            <div class="logo">
                <div class="logo_gamegear">
                    <a href="{{route('home')}}"> <img class="logo_gamegear_title" src={{asset('assets/images/img/sidebar/logo_gamegear1.png')}}
                        alt=""></a>
                </div>
            ...
            <div class="sidebar_social">
                <li>
                    <a href="mailto:gaminggear.2108@gmail.com">
                        <i class='bx bxl-google'></i>
                    </a>
                    <!-- <span class="tooltip">Profile</span> -->
                </li>
                <li>
                    <a href="https://www.facebook.com/Game-Gear-109222268527912">
                ...
                <li>
                    <a href="https://gitlab.com/CThinhIT/project2">
            ...
            <div style="color: #ffff;" class="sidebar_help">
                <a href="{{url('contactUs')}}"><span class="sidebar_help_contact">Contact</span></a>
                <a href="{{url('about')}}"><span class="sidebar_help_aboutus">About us</span></a>
            </div>
